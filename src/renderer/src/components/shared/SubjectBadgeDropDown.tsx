...
export default function SubjectBadgeDropDown({ name, color, data }: subject): JSX.Element {
  ...
  return (
    <div className="flex items-center relative">
      <div
        className={`rounded-3xl px-4 w-30 py-2 mr-2 text-center transition-all duration-500 hover:shadow-lg overflow-hidden relative group smooth-scale`}
        style={{
